...
- [ ] **Redator** — Specs SDD por componente
  ...
  - [x] `cart/design.md` ✅
  - [x] `cart/tasks.md` ✅
  - [x] `cart/carrinho-publico/requirements.md` ✅
  - [x] `cart/carrinho-publico/design.md` ✅
  - [x] `cart/carrinho-publico/tasks.md` ✅
  - [x] `cart/sessao-merge-guest/requirements.md` ✅
  - [x] `cart/sessao-merge-guest/design.md` ✅
  - [x] `cart/sessao-merge-guest/tasks.md` ✅
  - [x] `cart/cupom-frete-carrinho/requirements.md` ✅
  - [x] `cart/cupom-frete-carrinho/design.md` ✅
  - [x] `cart/cupom-frete-carrinho/tasks.md` ✅
  - [x] `coupons/requirements.md` ✅
  - [x] `coupons/design.md` ✅
  - [x] `coupons/tasks.md` ✅
  - [x] `coupons/admin-cupons/requirements.md` ✅
  - [x] `coupons/admin-cupons/design.md` ✅
  - [x] `coupons/admin-cupons/tasks.md` ✅
  - [x] `coupons/cupom-publico-carrinho/requirements.md` ✅
  - [x] `coupons/cupom-publico-carrinho/design.md` ✅
  - [x] `coupons/cupom-publico-carrinho/tasks.md` ✅
  - [x] `shipping/requirements.md` ✅
  - [x] `shipping/design.md` ✅
  - [x] `shipping/tasks.md` ✅
  - [x] `shipping/admin-frete-manual/requirements.md` ✅
  - [x] `shipping/admin-frete-manual/design.md` ✅
  - [x] `shipping/admin-frete-manual/tasks.md` ✅
  - [x] `shipping/cotacao-publica-carrinho/requirements.md` ✅
  - [x] `shipping/cotacao-publica-carrinho/design.md` ✅
  - [x] `shipping/cotacao-publica-carrinho/tasks.md` ✅
  - [x] `checkout/requirements.md` ✅
  - [x] `checkout/design.md` ✅
  - [x] `checkout/tasks.md` ✅
  - [x] `checkout/revisao-pedido-pendente/requirements.md` ✅
  - [x] `checkout/revisao-pedido-pendente/design.md` ✅
  - [x] `checkout/revisao-pedido-pendente/tasks.md` ✅
  - [x] `checkout/snapshots-validacao/requirements.md` ✅
  - [x] `checkout/snapshots-validacao/design.md` ✅
  - [x] `checkout/snapshots-validacao/tasks.md` ✅
