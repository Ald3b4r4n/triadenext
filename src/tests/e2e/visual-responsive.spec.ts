...
test("storefront routes do not overflow horizontally on required breakpoints", async ({ page }) => {
...
test("admin remains protected and stable on desktop width", async ({ page }) => {
