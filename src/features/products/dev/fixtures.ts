...
export const devProducts: Product[] = [
  ...
  },
  {
    ...
    description: "Não deve aparecer como disponível para compra.",
    brand: "Marca de exemplo",
  ...
  },
  {
    ...
    description: "Não deve ser tratado como público antes de publishedAt.",
    brand: null,
    inspirationName: null,
    gender: "nao_informado",
    concentration: null,
  ...
  },
  {
    ...
    description: "Não deve ser tratado como público ou comprável.",
    brand: null,
    inspirationName: null,
    gender: "nao_informado",
    concentration: null,
  ...
  },
  {
    ...
    description:
      "Inactive é tratado como inativo/arquivado nesta fase, pendente validação humana.",
    brand: null,
    inspirationName: null,
    gender: "nao_informado",
    concentration: null,
