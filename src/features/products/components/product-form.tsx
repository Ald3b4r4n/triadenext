    ...
    <form className="product-form" action={formAction}>
      ...
      <section className="form-panel">
        <div className="form-panel__header">
          ...
          <p className="muted">
            Campos essenciais para catálogo, vitrine e paridade pública.
          </p>
        </div>
        <div className="form-grid">
          ...
          <label className="form-field">
            ...
            <select
              name="gender"
              defaultValue={product?.gender ?? "nao_informado"}
            >
      ...
      <section className="form-panel">
        ...
        {state.fields?.status ? (
          <p className="field-error">{state.fields.status}</p>
        ) : null}
        ...
        <div className="form-grid">
          ...
          <label className="form-field">
            ...
            <input
              ...
              defaultValue={product?.inspirationName ?? ""}
            />
          </label>
          <label className="form-field">
