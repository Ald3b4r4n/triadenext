...
|---|---|---|
| 2026-07-01 | Re-extração pós-Fase 12 | verde: carrinho convertido, guest token opaco, fallback sem banco e ausência de bypass admin permanecem documentados; readiness não altera carrinho. |
